...
- Leggere almeno 7 libri. **Progresso 5/7** :cloud:.
...
- :computer: Imparare a programmare su piattaforma Arduino completando gli esercizi base **Progresso 7/10** :cloud:.
...
- :uk: Migliorare il mio inglese sfruttando la piattaforma messa a disposizione dalla azienda in cui lavoro per almeno 8 ore al mese *Progresso 21/96hh pari al 20%* [gofluent.com](https://portal.gofluent.com/group/client).
