...
- Leggere almeno 7 libri. **Progresso 7/7** :sunny:.
    ...
    6. Parag Khanna, _Il secolo asiatico?_, Fazi, 7 marzo 2019. [Amazon](https://www.amazon.it/secolo-asiatico-Parag-Khanna-ebook/dp/B07NS72KG6/ref=tmm_kin_swatch_0?_encoding=UTF8&qid=1581343243&sr=8-1).
    7. Federico Faggin, _Silicio_, Mondadori, 30 Aprile 2019. [Amazon](https://www.amazon.it/gp/product/B07Q3C95G6/ref=ppx_yo_dt_b_d_asin_title_o09?ie=UTF8&psc=1).

## :running: Corsa

- Completare almeno 35 corse e almeno 250 Km totali. **Progresso 7/35 per un totale di 55 Km** :umbrella:. [Strava](https://www.strava.com/athletes/27329378/training/log?feature=public-training-log)

## :rocket: Lifelong learning

- :computer: Imparare a programmare su piattaforma Arduino completando gli esercizi base **Progresso 9/10** :cloud:.
...
- :uk: Migliorare il mio inglese sfruttando la piattaforma messa a disposizione dalla azienda in cui lavoro per almeno 8 ore al mese *Progresso 39/96hh pari al 37%* [gofluent.com](https://portal.gofluent.com/group/client).

- :wrench:  Imparare a saldare con un saldatore a stagno dei semplici circuiti elettronici. **Progresso 1/1** :sunny:
